...
import static edu.njnu.Translate.element.OperatorEnum.*;
import static edu.njnu.Translate.element.TypeEnum.*;
import static edu.njnu.Translate.element.ActionEnum.*;
...
public class Table {
    ...
    static {
	    ...
	    int i = 0;
	    for (Action value : actionTable.values()) {
	...
	public static List<Action> getReduceRules() {
    	return actionTable.values().stream()
			    .filter(a -> a.type == Reduce)
